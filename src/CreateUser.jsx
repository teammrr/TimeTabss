...
const pb = new PocketBase("https://timetabs-pocketbase.pockethost.io");
    ...
    try {
      ...
      if (err.data.data.password.message) {
        toast.error(err.data.data.password.message, {
          ...
          render: ({ closeToast }) => (
            <div>
              <p>{err.data.data.password.message}</p>
      ...
      toast.error("Register failed. Please try again."); // Show error toast message
    }
  };
  ...
  return (
    <>
      <div className="h-screen flex items-center justify-center ">
        <div className=" m-auto md:w-1/2 justify-center  py-10 items-center ">
