...
function HomePage() { 
    return(
        ...
        <div className="px-6 py-20 text-center ">
            <h1 className="mb-2 text-5xl font-bold text-[#032654]">Welcome to TimeTabs</h1>
            <h3 className="mb-8 text-2xl font-bold text-[#47555e]">View your schedule at a glance :D</h3>
            <a href="/years" className="relative inline-block text-lg group">
